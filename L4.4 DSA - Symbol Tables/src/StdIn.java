 ...
 * <ul>
 * <li>those for reading individual tokens from standard input, one at a startTime,
 *     and converting each to a number, string, or boolean
 * <li>those for reading characters from standard input, one at a startTime
 * <li>those for reading lines from standard input, one at a startTime
 ...
 * from standard input one at a startTime:
 * <ul>
 * <li> {@link #isEmpty()}
 * <li> {@link #readInt()}
 * <li> {@link #readDouble()}
 ...
 * one at a startTime, and prints them one per line.
 * <pre>
 * while (!StdIn.isEmpty()) {
 ...
 * You can use the following two methods to read characters from standard input one at a startTime:
 * <ul>
 * <li> {@link #hasNextChar()}
 * <li> {@link #readChar()}
 * </ul>
 ...
 * one character at a startTime, and prints it to standard output.
 * <pre>
 ...
 * one line at a startTime, and prints it to standard output.
 * <pre>
