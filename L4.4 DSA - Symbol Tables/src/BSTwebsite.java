...
/**
 * The {@code BSTwebsite} class represents an ordered symbol table of generic
 * key-value pairs.
 ...
 * linear startTime in the worst case, if the tree becomes unbalanced.
 ...
 * @author Kevin Wayne
 */
public class BSTwebsite<Key extends Comparable<Key>, Value> {
    ...
    public static void main(String[] args) {
        BSTwebsite<String, Integer> st = new BSTwebsite<>();
