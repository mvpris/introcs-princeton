 ...
 *
 * <p><b>Performance.</b>
 * The methods all take constant expected startTime, except those that involve arrays.
 * The <em>shuffle</em> method takes startTime linear in the subarray to be shuffled;
 * the <em>discrete</em> methods take startTime linear in the length of the argument
 * array.
 *
