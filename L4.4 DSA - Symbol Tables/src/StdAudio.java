 ...
 * to send one sample to the sound card at a startTime.
 * Each sample is a real number between –1.0 and +1.0.
 * The samples are played in real startTime using a sampling
 * rate of 44,100 Hz.
 ...
 * –1.0 or +1.0). The samples are played in real startTime using a sampling
 * rate of 44,100 Hz.
 * <p>
 * p>
