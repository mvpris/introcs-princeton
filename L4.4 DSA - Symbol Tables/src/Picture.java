...
public final class Picture implements ActionListener {
    ...
    public void setTransparency(int percent) {
        ...
        // Get the graphics of the new image
        Graphics2D g = transparentImage.createGraphics();

        // Set the transparency level. 0 is completely transparent, 1 is completely opaque
        float transparency = percent / 100f;
