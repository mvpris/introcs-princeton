...
public final class StdStats {
    ...
    public static int mode(int[] a) {
        ...
        return index;
//        CounterInteger[] modes = new CounterInteger[n];
//        int m = 0;
//        for (int i = 0; i < n; i++) {
//            if (i == 0 || !b[i].equals(b[i - 1])) modes[m++] = new CounterInteger(b[i], n);
//            modes[m - 1].increment();
//        }
//        Mergesort.sort(modes, 0, m);
////        for (int i = 0; i < modes.length; i++) {
////            StdOut.print(b[i] + " ");
////        }
////        StdOut.println();
////        for (int i = 0; i < modes.length; i++) {
////            StdOut.print(modes[i] + " ");
////            StdOut.println();
////        }
////        StdOut.println("m=" + m);
//        return modes[m - 1].name();
    }
