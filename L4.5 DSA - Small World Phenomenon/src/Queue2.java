...
/**
 * The {@code Queue2} class represents a first-in-first-out (FIFO) queue of
...
public class Queue2<Item> implements Iterable<Item> {
     ...
     */
    public Item peek() {
        if (isEmpty()) throw new NoSuchElementException("Queue2 underflow");
        return first.item;
    }
    ...
    /**
     * Unit tests the {@code Queue2} data type.
     *
